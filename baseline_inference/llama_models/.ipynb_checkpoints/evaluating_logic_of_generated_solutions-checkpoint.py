...
if not OPENAI_API_KEY:
    OPENAI_API_KEY = "Put your API_Key_Here"  # Fallback to provided key if env var not set
...
parser = argparse.ArgumentParser(description="Evaluate logical reasoning of responses using gpt-4o as a judge.")
...
dataset_dir = "Your dataset directory here"
...
for lang in selected_languages:
    input_csv_path = os.path.join(dataset_dir, f"{lang}_llama3.1_8B_instruct_inference_data.csv")
    output_csv_path = os.path.join(output_dir, f"{lang}_llama3.1_8B_logic_evaluation.csv")
