...
dataset_dir = "/standard/AikyamLab/eric/Multilingual medical reasoning/Baselines/other_models_inference/ultramedical/Llama-3-8B-UltraMedical_results"
...
for lang in selected_languages:
    input_csv_path = os.path.join(dataset_dir, f"{lang}_with_test_responses.csv")
