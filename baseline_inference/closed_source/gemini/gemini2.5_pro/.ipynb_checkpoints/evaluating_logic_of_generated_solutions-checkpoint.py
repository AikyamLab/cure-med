...
dataset_dir = "/standard/AikyamLab/eric/Multilingual medical reasoning/conversational finetuning/closed_source/gemini/gemini2.5_pro/gemini_inference_testdataset"
...
for lang in selected_languages:
    input_csv_path = os.path.join(dataset_dir, f"{lang}_gemini_inference_data.csv")
