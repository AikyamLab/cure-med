...
dataset_dir = "/standard/AikyamLab/eric/Multilingual medical reasoning/Baselines/Multi_Med_Inference/Meditron/meditron_7B_inference_testdataset"
...
for lang in selected_languages:
    input_csv_path = os.path.join(dataset_dir, f"{lang}_meditron_7B_inference_data.csv")
