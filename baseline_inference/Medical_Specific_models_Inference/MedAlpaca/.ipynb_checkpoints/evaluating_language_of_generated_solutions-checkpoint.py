...
if not OPENAI_API_KEY:
    OPENAI_API_KEY = "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"  
...
dataset_dir = "/standard/AikyamLab/eric/Multilingual medical reasoning/Baselines/Multi_Med_Inference/MedAlpaca/medalpaca_13b_inference_testdataset"
...
Determine if the model response is entirely in {language} (the language of the question)? Check for no mixing with other languages, no unnecessary repetitions, no drifts, and a proper conclusion to the question. Your task is to simply output "True" if the criteria is met, and "False" otherwise.
"""
...
for lang in selected_languages:
    input_csv_path = os.path.join(dataset_dir, f"{lang}_medalpaca_7b_inference_data.csv")
    output_csv_path = os.path.join(output_dir, f"{lang}_qwen2.5_1.5B_language_evaluation.csv")
