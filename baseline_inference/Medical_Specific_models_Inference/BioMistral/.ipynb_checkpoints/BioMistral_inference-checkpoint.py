# -------------------------------
# BioMistral-7B Batch Inference Script for Test Datasets
# -------------------------------
import os
import pandas as pd
...
# Set pad token to eos token (common fix for Mistral-based models without a dedicated pad token)
...
if __name__ == "__main__":
    ...
    # Output directory
    output_dir = "biomistral_7B_inference_testdataset"
    ...
    for lang in process_languages:
        ...
        new_filename = f"{lang}_biomistral_7B_inference_data.csv"
