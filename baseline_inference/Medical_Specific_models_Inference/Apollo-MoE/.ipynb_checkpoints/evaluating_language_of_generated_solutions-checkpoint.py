...
parser = argparse.ArgumentParser(description="Evaluate language of responses using gpt-4o as a judge.")
...
dataset_dir = "/standard/AikyamLab/eric/Multilingual medical reasoning/Baselines/Multi_Med_Inference/Apollo-MoE/apollo2_7b_inference_testdataset"
...
for lang in selected_languages:
    input_csv_path = os.path.join(dataset_dir, f"{lang}_apollo2_7b_inference_data.csv")
