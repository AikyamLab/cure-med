...
dataset_dir = "/standard/AikyamLab/eric/Multilingual medical reasoning/Baselines/Multi_Med_Inference/Mistral/mistral_7B_instruct_v03_inference_testdataset"
...
for lang in selected_languages:
    input_csv_path = os.path.join(dataset_dir, f"{lang}_mistral_7B_instruct_v03_inference_data.csv")
