# -------------------------------
# Mistral-7B-Instruct-v0.3 Batch Inference Script for Test Datasets
# -------------------------------
import os
import pandas as pd
...
# Set pad token to eos token (common fix for Mistral models without a dedicated pad token)
...
def generate_response(question, lang, max_new_tokens=1024):
    ...
    inputs = tokenizer.apply_chat_template(
        ...
        return_tensors="pt",
        return_dict=True  # To get dict with input_ids and attention_mask
    ).to(model.device)
    with torch.no_grad():
...
if __name__ == "__main__":
    ...
    # Output directory
    output_dir = "mistral_7B_instruct_v03_inference_testdataset"
    ...
    for lang in process_languages:
        ...
        new_filename = f"{lang}_mistral_7B_instruct_v03_inference_data.csv"
