...
output_dir="stage_one_high_output_${uid}"
...
--rdzv_backend c10d \
training_stage_one_high.py \
--dataset_path "/standard/AikyamLab/eric/Multilingual medical reasoning/conversational finetuning/NEW_ALGORITHM_3RD/QWEN2.5_1.5B-INSTRUCT/Curriculum_RFT/staged/high" \
--block_size 2048 \
