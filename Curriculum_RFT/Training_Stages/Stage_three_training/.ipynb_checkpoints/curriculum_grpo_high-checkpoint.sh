...
output_dir="stage_three_low_output_${uid}"
...
--dataset_path "/standard/AikyamLab/eric/Multilingual medical reasoning/conversational finetuning/NEW_ALGORITHM_3RD/QWEN2.5_1.5B-INSTRUCT/Curriculum_RFT/staged/low" \
--block_size 2048 \
