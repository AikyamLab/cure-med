...
output_dir="stage_three_part2_output_${uid}"
...
--rdzv_backend c10d \
training_stage_three_low.py \
--dataset_path "/standard/AikyamLab/eric/Multilingual medical reasoning/conversational finetuning/NEW_ALGORITHM_3RD/Curriculum_RFT/staged/low" \
--block_size 2048 \
