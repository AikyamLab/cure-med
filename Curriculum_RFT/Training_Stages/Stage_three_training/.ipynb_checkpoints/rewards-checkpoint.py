...
Implements composite reward with components: quality (accuracy), language consistency,
and format. 
Uses GPT-4.1-mini for quality and language scoring.
"""
...
class RewardConfig:
    ...
    You are an expert multilingual medical evaluator. Determine if the final answer of the model is entirely in the language of the question. Score based on the language of the question and the final answer. Not the reasoning. 
