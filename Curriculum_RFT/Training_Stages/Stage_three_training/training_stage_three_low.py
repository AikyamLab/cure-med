...
RANDOM_SEED = 42
SFT_MODEL_PATH = "Your model here"

STAGE_DATASET_PATH = "/standard/AikyamLab/eric/Multilingual medical reasoning/conversational finetuning/NEW_ALGORITHM_3RD/QWEN2.5_1.5B-INSTRUCT/Curriculum_RFT/staged/low"
